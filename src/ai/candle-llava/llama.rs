...
modify forward procedure to better fit LLaVA model
*/
...
// Simplified: remove flash-attn optional path; always use fallback implementation.
fn flash_attn(_: &Tensor, _: &Tensor, _: &Tensor, _: f32, _: bool) -> Result<Tensor> {
    unimplemented!("flash-attn removed in this minimal port")
}

impl CausalSelfAttention {
    fn apply_rotary_emb(&self, x: &Tensor, index_pos: usize, cache: &Cache) -> Result<Tensor> {
    // tracing span removed
