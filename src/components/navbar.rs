...
pub fn NewNavbar(props: NewNavbarProps) -> Element {
    let NewNavbarProps { mut ui, mut view_mode, mut preview_collapsed, mut qa_collapsed, mut drives_collapsed, mut results, mut app_view, error, mut filters, scan_generation, mut scanning, mut dir_items, progress, ai_search_engine, selected_paths, mut auto_indexing, mut search_text, mut ai_search_results, mut ai_search_active, mut group_by_category, selected_path: _selected_path, mut nav_history, mut recursive_current, mut only_subdirs, mut scan_started, mut scan_finished, ext_filters, mut ext_enabled, mut excluded_dirs, bulk_progress, bulk_generating } = props;
    ...
    rsx! {
        nav { class: "app-nav flex items-center gap-3 px-2 panel h-12",
            "data-style": "outline",
            // Top menus rebuilt with DropdownMenuItem + on_select
            div { class: "flex gap-1 flex-1 items-center",
                // File
                DropdownMenu { class: "menubar",
                    DropdownMenuTrigger { class: "menubar-trigger button", "data-style": "glass", "File" }
                ...
                // View
                DropdownMenu { class: "menubar",
                    DropdownMenuTrigger { class: "menubar-trigger button px-3 py-1", "data-style": "glass", "View" }
                ...
                // Scan
                DropdownMenu { class: "menubar",
                    DropdownMenuTrigger { class: "menubar-trigger button px-3 py-1", "data-style": "glass", "Scan" }
                ...
                // AI
                DropdownMenu { class: "menubar",
                    DropdownMenuTrigger { class: "menubar-trigger button px-3 py-1", "data-style": "glass", "AI" }
                ...
                // Filters (panel)
                DropdownMenu { class: "menubar",
                    DropdownMenuTrigger { class: "menubar-trigger button px-3 py-1", "data-style": "glass", "Filters" }
            ...
            div { class: "flex items-center gap-2",
                ...
                if *ai_search_active.read() {
                    span { class: "badge", "data-variant": "ai", "AI" }
                }
                if *bulk_generating.read() {
                    span { class: "badge", "data-variant": "progress",
                        {
            ...
            dioxus_primitives::dialog::DialogContent { class: "dialog",
                ...
                div { class: "flex flex-col gap-3 mt-2",
                    ...
                    div { class: "flex flex-col gap-1",
                        ...
                        textarea {
                            class: "form-field w-full h-48 font-mono text-10px",
            ...
            dioxus_primitives::dialog::DialogContent { class: "dialog",
                ...
                div { class: "flex flex-col gap-3 mt-2 w-[520px] max-w-[90vw]",
                    div { class: "flex flex-col gap-1",
                        ...
                        textarea {
                            class: "form-field h-32 text-10px font-mono",
                    ...
                    div { class: "flex flex-col gap-1",
                        ...
                        input {
                            class: "form-field text-10px font-mono",
                    ...
                    div { class: "flex gap-2 justify-end pt-2",
                        button {
                            class: "button px-3 py-1 text-10px",
                            "data-style": "outline",
                            onclick: move |_| {
                                let mut f = filters.write();
