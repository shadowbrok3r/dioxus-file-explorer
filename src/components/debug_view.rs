    ...
    rsx! {
        div {
            ...
            div {
                ...
                span { class: "panel rounded", "data-style": "outline", style: "padding: 5px 20px; margin: 10px 10px",
                ...
                if let Some(c) = *missing_desc_count.read() {
                    span { class: "panel px-2 py-1 rounded", "data-style": "outline",
                        "Missing: {c}"
                    }
                }
            ...
            if thumbs.read().is_empty() {
            ...
            } else {
                {
                    ...
                    rsx! {
                        div {
                            class: "overflow-auto panel rounded-md",
                            "data-style": "outline",
                    ...
                    for d in docs.read().iter() {
                        {
                            let d_clone = d.clone();
                            rsx! {
                                li { class: "p-2 rounded panel hover:border-accent transition",
                                    "data-style": "outline",
                                    {
